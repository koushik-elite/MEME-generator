...
<html lang="en">
	...
	<body onload="init();">
		...
		<div class="block advanced mainblock">
			<label class="title closable">Image Effects</label>
			<div class="optionblock">
				<div class="block">
					<a href="#" class="custom_button" id="redpopart" >Red Pop Art</a>
					<a href="#" class="custom_button" id="greenpopart" >Green Pop Art</a>
		...
		<script>
			...
			function init() {
				...
				$("label.title.closable").click(function() {
					$("div.mainblock").removeClass("open");
					$(this).closest("div.mainblock").toggleClass("open");
					return false;
				});
